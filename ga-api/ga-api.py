...
CLIENT_SECRETS = file_base +'client_secrets.json'
...
def main(argv):
  ...
  storage = Storage(file_base +'sample.dat')
  ...
  try:
    ...
    try:
        api_query = service.data().ga().get(
            ids=ga_account,
            start_date=tstamp.strftime('%Y-%m-%d'),
            end_date=tstamp.strftime('%Y-%m-%d'),
            metrics='ga:visits',
            dimensions='ga:hour'
        )
        #print api_query
...
# For more information on the Google Analytics API API you can visit:
#
#   https://developers.google.com/analytics/
#
# For more information on the Google Analytics API API python library surface you
# can visit:
    #
